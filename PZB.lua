	...
	---------------PZB FUNCTIONS---------------
        ...
        WachsamPressed = function(self)
            if PZB90.acknowledgeCountdown > 0 then
                ...
                elseif PZB90.restrictionToConfirm.type == 500 then
                    PZB90.countdown500HzLight = PZB90.restrictionToConfirm.countdownLight
                    PZB90.countdown500HzMonitoring = PZB90.restrictionToConfirm.countdownMonitoring
                    if PZB90.slowdown500HzCountdown == -1 then
                        PZB90.slowdown500HzCountdown = PZB90.restrictionToConfirm.countdownSlowdown
                    end
			...
			if PZB90.active then
				...
				-------------------LIGHTS-------------------
					...
					if PZB90.blinkCounter > 0.5 then
						...
						if PZB90.trainType == PZB90.LOW and ((PZB90.countdown1000HzMonitoring > 0 and not PZB90.restricted1000Hz) or (PZB90.countdown500HzMonitoring > 0 and not PZB90.restricted500Hz)) and PZB90.displayRestriction then
						...
						if PZB90.trainType == PZB90.MIDDLE and ((PZB90.countdown1000HzMonitoring > 0 and not PZB90.restricted1000Hz) or (PZB90.countdown500HzMonitoring > 0 and not PZB90.restricted500Hz)) and PZB90.displayRestriction then
							PZB90.light55 = false
							PZB90.light55Inv = false
						...
						if PZB90.trainType == PZB90.HIGH and ((PZB90.countdown1000HzMonitoring > 0 and not PZB90.restricted1000Hz) or (PZB90.countdown500HzMonitoring > 0 and not PZB90.restricted500Hz)) and PZB90.displayRestriction then
							PZB90.light55 = false
							PZB90.light55Inv = false
							PZB90.light70 = false
							PZB90.light70Inv = false
